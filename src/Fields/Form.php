...
class Form extends Group
{
	...
	{
		if (mb_strtolower($this->attr('method')) === 'post') {
	 ...
	 * @param array $files An array with all files values
	 *
	 * @return array|mixed The files values fixed
	 */
	 ...
	 *
	 * @return \FormManager\Elements\ElementContainer|\FormManager\Fields\Form
	 */
